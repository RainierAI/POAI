...
class MainPage extends StatelessWidget {
  ...
  final pController = Get.put(PurchaseController());
    ...
    return GestureDetector(
      ...
      child: Obx(
        () => Scaffold(
          ...
          appBar: AppBar(
            surfaceTintColor: (mainController.isDarkMode.value)
                ? Clr.darkGray
                : Clr.lightGray,
              ...
              GestureDetector(
                ...
                child: Padding(
                  ...
                  child: Image.asset(
                    ...
                    fit: BoxFit.cover,
                    color:
                        (mainController.isDarkMode.value) ? null : Clr.darkGray,
                  ),
                ),
              ),
            ],
                                ...
                                Row(
                                  ...
                                  children: [
                                    SizedBox(
                                      ...
                                      height: 30,
                                      child:
                                          Image.asset('assets/aiprofile.png'),
                                    ),
                                    SizedBox(
                                      width: 16,
                                    ),
                                    (contentsList[index].content!.isNotEmpty)
                                        ? Flexible(
                                            child: Text(
                                              contentsList[index].content!,
                                              style: TextStyle(
                    ...
                    () => TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        suffixIcon: GestureDetector(
                          onTap: () {
                            if (mainController.isEnabled.value) {
                              if (mainController.isGenerating.value == false &&
                                  mainController.userInput.value.isNotEmpty) {
                                mainController.isEnabled.value = false;
                          ...
                          child: Icon(
                            ...
                            color: (mainController.userInput.value.isEmpty)
                                ? Clr.gray500
                                : (mainController.isGenerating.value == false)
                                    ? Clr.neonGreen
                                    : Clr.gray500,
                            size: 30,
                          ),
                      ...
                      cursorColor: (mainController.isDarkMode.value)
                          ? Clr.lightGray
                          : Clr.darkGray,
                    ),
                  ),
